...
concatenar: ConcatenarConRecorte PAR_A lista_expresiones PAR_C; 

lista_expresiones: 	factor
					|lista_expresiones COMA factor;


indice: FirstIndexOf PAR_A expresiones PAR_C ;

expresiones: ID PUN_Y_COM COR_A expr COR_C ;
...
factor:			ID { printf("Condicion ID - OK\n"); } 
				...
				|concatenar { printf("Condicion Concatenar - OK\n"); } 
				|indice { printf("Condicion Indice - OK\n"); } ;
